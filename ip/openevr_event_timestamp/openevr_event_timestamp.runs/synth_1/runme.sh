...
HD_PWD='/home/adam/Tresbox/vivado/openevr_event_timestamp/openevr_event_timestamp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log event_timestamp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source event_timestamp.tcl
